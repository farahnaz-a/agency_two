    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('abouts.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="title" value="{{ $about->title }}">
                                    @error('title')
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-1">
                                    <img  class="w-25" src="{{ asset('uploads/abouts')}}/{{ $about->image }}" alt=""> 
                                </div>
                            </div>
