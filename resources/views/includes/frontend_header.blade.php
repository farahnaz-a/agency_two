...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend_assets/images/MSHAgency.png')}}">
...
<!-- font family -->
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets/css/icofont.min.css')}}">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active mr-10" aria-current="page" href="#">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mr-10" href="#about__part">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mr-10" href="#service__part">Service</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mr-10" href="#testimonial__section">Testimonial</a>
          </li>
           <li class="nav-item">
            <a class="nav-link mr-10" href="#getin__touch">Contact</a>
          </li> 
        </ul>
